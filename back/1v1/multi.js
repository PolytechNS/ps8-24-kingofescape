const GameManager = require("../logic/gameManager").gameManager;
const Arbitre = require("../logic/arbitre").arbitre;
/**
 * Class GameMulti for the online game
 */
class GameMulti {

    /**
     * Constructor of the class GameMulti
    ...
    /**
     * Do an action in the game Multi
