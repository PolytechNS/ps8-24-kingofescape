...
const {getStatTable, setStatTable} = require('../sucess/sucess.js');
function calculeElo(stockPoints, resultatPartie, gestionSocketPlayer) {
        ...
        const nouveauEloJoueur1 = Math.round(eloJoueur1 + k * (resultatPartie - esperance1));
        const nouveauEloJoueur2 = Math.round(eloJoueur2 + k * ((1 - resultatPartie) - esperance2));
